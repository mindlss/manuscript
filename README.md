...
| `PATCH`| `/categories/:id`            | Обновить категорию                             | ✅ JWT   |
| `DELETE`| `/categories/:id`           | Удалить категорию                              | ✅ JWT   |
| `PATCH`| `/categories/:id/reorder`    | Переместить категорию (изменение позиции)      | ✅ JWT   |
...
### 📌 Переместить категорию (`PATCH /categories/:id/reorder`)
